...
const products = [
  ...
  },
  {
    ...
    desc: 'A gamified digital platform where knowledge earns real rewards. Sezwor turns everyday learning into competitive, community-driven experiences — quiz battles, subject leagues, and global leaderboards that connect young minds across continents.',
    features: [
      'Real-time multiplayer quiz battles (up to 500 players)',
      'Subject-based knowledge tracks: STEM, Humanities, Tech, AI',
      'Scholarship-linked reward system',
      'Cross-country school league competitions',
      'Live tournaments: Africa, Europe, Americas divisions',
